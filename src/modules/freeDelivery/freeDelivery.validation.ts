...
export const updateFreeDeliveryCampaignSchema = z
  .object({
    title: z
      .string()
      .trim()
...
export const updateFreeDeliveryCategorySourceSchema = z
  .object({
...
export const updateFreeDeliverySubCategorySourceSchema = z
  .object({
...
export const updateFreeDeliveryProductSourceSchema = z
  .object({
...
export const getFreeDeliveryPublicQuerySchema = z.object({
...
export type UpdateFreeDeliveryCampaignInput = z.infer<typeof updateFreeDeliveryCampaignSchema>;
export type UpdateFreeDeliveryCategorySourceInput = z.infer<
  typeof updateFreeDeliveryCategorySourceSchema
>;
export type UpdateFreeDeliverySubCategorySourceInput = z.infer<
  typeof updateFreeDeliverySubCategorySourceSchema
>;
export type UpdateFreeDeliveryProductSourceInput = z.infer<
  typeof updateFreeDeliveryProductSourceSchema
>;
export type GetFreeDeliveryPublicQueryInput = z.infer<typeof getFreeDeliveryPublicQuerySchema>;
